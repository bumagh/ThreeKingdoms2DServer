...
int model_user_goods_add (int user_id,
                         char* goods_name,
                         int goods_name_len,
                         int counts)
{
...
int model_user_goods_getColVal (int user_id,
                               int goods_id,
                               char* colName,
                               int* colVal)
{
